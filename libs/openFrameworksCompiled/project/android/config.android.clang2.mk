...
PLATFORM_CFLAGS += -Wall $(ANDROID_PLATFORM_CFLAGS) -fsanitize=address -fno-omit-frame-pointer -fpic -D__ANDROID_API__=19
PLATFORM_CXXFLAGS =  -std=c++14 -fsanitize=address -fno-omit-frame-pointer -fpic

# Code Generation Option Flags (http://gcc.gnu.org/onlinedocs/gcc/Code-Gen-Options.html)
PLATFORM_CFLAGS += -nostdlib --sysroot=$(SYSROOT) -isystem $(SYSROOT)/usr/include/arm-linux-androideabi -fno-short-enums -ffunction-sections -fdata-sections

ifeq ($(ABI),armv7)
	PLATFORM_CFLAGS += -march=armv7-a -target armv7-none-linux-androideabi -mfloat-abi=softfp -mfpu=vfpv3-d16
endif
...
PLATFORM_LDFLAGS =
PLATFORM_LDFLAGS += --sysroot=$(NDK_ROOT)/platforms/$(NDK_PLATFORM)/arch-arm/ -v \
	-isystem $(NDK_ROOT)/platforms/$(NDK_PLATFORM)/arch-arm/ \
	-fsanitize=address \
	-nostdlib \
	-L"$(NDK_ROOT)/sources/cxx-stl/gnu-libstdc++/$(GCC_VERSION)/libs/$(ABI_PATH)" \
	-gcc-toolchain $(NDK_ROOT)/toolchains/arm-linux-androideabi-4.9/prebuilt/$(HOST_PLATFORM) \
	-march=armv7-a \
...
PLATFORM_LIBRARIES += gnustl_shared
...
PLATFORM_CC=$(ANDROID_BIN)/clang
PLATFORM_CXX=$(ANDROID_BIN)/clang++
PLATFORM_AR=/Users/kkirbatski/android/ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ar
