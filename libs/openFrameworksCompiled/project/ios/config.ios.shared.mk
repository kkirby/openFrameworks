...
PLATFORM_LDFLAGS = $(CXX_ARGS) $(STANDARD_FLAGS) -v -shared -compatibility_version $(PROJECT_COMPATABILITY_VERSION) -current_version $(PROJECT_CURRENT_VERSION) -install_name @rpath/$(APPNAME).framework/$(APPNAME) -read_only_relocs suppress
